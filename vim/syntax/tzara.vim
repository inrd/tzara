...
syn keyword tzNode module var add sub mult div modulo clip equal min max round and or xor mix map miditofreq samplerate mem count phasor pulse sinosc seq8 random segment select delay fdelay
