...
syn keyword tzNode module matrix mget mset defaultval var add sub mult div modulo pow sqrt abs sin cos tan tanh clip wrap equal nequal lower greater min max round ceil floor frac and or xor mix merge pmerge map from0_1 to0_1 smooth miditofreq dbtoamp mstohz hztoms samplerate duration fixdenorm fixnan count phasor pulse sinosc sawosc sqrosc triosc noise seq8 random irandom notescale segment adenv select route sah gate timepoint lowpass highpass lowpass2 highpass2 bandpass notch peak lowshelf highshelf svf delay fdelay allpass
