...
syn keyword tzNode module var add sub mult div modulo clip round and or xor mix map miditofreq mem phasor pulse sinosc seq8 random segment select delay fdelay
